    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-zinc-50 font-sans dark:bg-black">
            ...
            <main className="flex w-full max-w-3xl flex-col items-center justify-center p-8 bg-white dark:bg-black rounded-2xl shadow-lg">
                ...
                <form onSubmit={handleSubmit} className="bg-black dark:bg-white p-8 rounded-2xl shadow-md w-80 items-center">
                    <h1 className="text-2xl font-bold mb-4 text-center dark:text-black text-white">Login</h1>
